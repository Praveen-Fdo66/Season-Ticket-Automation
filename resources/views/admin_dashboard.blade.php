    ...
    <div class="flex">
        <aside class="bg-[#05445E] text-white w-64 min-h-screen fixed left-0 top-0 hidden md:block">
            ...
            <nav class="mt-6 text-center">
                <ul>
                    <li class="p-4"><a href="#" class="block sidebar-link" data-page="a_dashboard">Dashboard</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="sidebar-link" data-page="applicants">Applicants</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="sidebar-link" data-page="passengers">Passengers</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="sidebar-link" data-page="system_admins">System Admins</a></li>
...
<div class="ml-0 md:ml-64 flex-1 p-6">
        ...
        <div class="absolute top-1/2 right-4 transform -translate-y-1/2 ">
            <div class="relative">
                ...
                <button id="profile-btn" class="flex items-center space-x-1 bg-white p-1 rounded-full shadow-md focus:outline-none">
                    ...
                    <span class="hidden md:inline-block font-semibold text-sm text-[#05445E]">Admin</span>
                </button>
    ...
    <div id="content" class="mt-6">
        @include('admin_dashboard.pages.a_dashboard') <!-- Default content -->
    </div>
</div>
...
function loadPage(page) {
    fetch(`/admin_dashboard/pages/${page}`)
...
//Active link color change
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const currentPage = localStorage.getItem("activePage") || "admin_dashboard";
