    ...
    <div class="flex">
        <aside class="bg-[#05445E] text-white w-64 min-h-screen fixed left-0 top-0 hidden md:block">
            ...
            <nav class="mt-6 text-center">
                <ul>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="block sidebar-link" data-page="dashboard">Dashboard</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="block sidebar-link" data-page="renew_ticket">Renew Ticket</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="block sidebar-link" data-page="get_season_ticket">Get Season Ticket</a></li>
                    <li class="p-4 hover:bg-[#189AB4]"><a href="#" class="block sidebar-link" data-page="cancel_season">Cancel Season</a></li>
...
<div class="ml-0 md:ml-64 flex-1 p-6">
    <div class="bg-[#75E6DA] p-6 text-[#05445E] font-bold text-xl text-center relative ">
        DASHBOARD OVERVIEW
    ...
    <div id="content" class="mt-6">
        @include('user_dashboard.pages.dashboard') <!-- Default content -->
    </div>
</div>
