...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
    ...
    <div class="bg-[#E0F7FA] p-6 shadow-lg rounded-lg flex flex-col items-center md:col-span-2 w-full">
        <img src="{{ asset('images/user.jpg') }}" alt="Profile Photo" class="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-gray-300">
        <h3 class="font-bold text-lg md:text-xl mt-4 text-center">Panawannage Praveen Achintha Fernando</h3>
        <p class="text-gray-600 text-sm md:text-base text-center">NIC : 200506503590</p>
        <p class="text-gray-600 text-sm md:text-base text-center">Email : fernandojr662005@gmail.com</p>
        <p class="text-gray-600 text-sm md:text-base text-center">Applicant ID : 2001</p>
        <p class="text-gray-600 text-sm md:text-base text-center">Passenger ID : 9001</p>
