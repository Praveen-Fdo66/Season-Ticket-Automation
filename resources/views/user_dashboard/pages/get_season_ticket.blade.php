    ...
    <form class="space-y-4 mt-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" class="w-full p-2 border border-gray-400 rounded-[15px] bg-gray-100" value="Panadura" >
            </div>
            <div>
                <label class="block font-semibold">To</label>
                <input type="text" class="w-full p-2 border border-gray-400 rounded-[15px] bg-gray-100" value="Colombo Fort" >
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
